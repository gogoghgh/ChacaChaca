...
public class ReviewContentAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("(from BoardContentAction) M: 글번호 " + bno + " 조회수 +1 완");
		
		// 게시판 글 1개의 정보를 가져와서 출력 == 멤버 1명 정보 출력했었던 거랑 똑같음!!
		ReviewDTO dto = dao.getBoard(bno); // 5. 특정 글 1개 정보 조회 메서드 getBoard.. 리턴타입 dto임
		System.out.println("(from BoardContentAction) M: dto: " + dto);
