...
<!-- ---------------------- 본문 -------------------------------- -->
       		<div class="row d-flex justify-content-center">
       			<div class="col-md-5 ">
<!--             		<form action="deletePro.jsp" method="post" class="p-2 contact-form" name="form" onsubmit="return delete1();"> -->
            		<form action="deletePro.jsp" method="post" class="p-2 contact-form" name="form"">
