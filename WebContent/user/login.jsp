            		...
            		<form action="./LoginAction.bo" method="post" class="p-2 contact-form">
	              		...
	              		<div class="form-group">
	             			<p class="d-flex justify-content-center mt-5 mb-0 d-block">
	                			<input type="submit" value="로그인" class="btn btn-primary py-3 px-5 mr-3 ">
	                			<input type="button" value="회원가입" class="btn btn-primary py-3 px-5 ml-3 " onclick="location.href='./Join.bo';">
	              			</p>
	              		</div>
            		</form>
          		</div>
