...
<section class="paymentresult">
	<div class="thanks">회원가입이 완료되었습니다.<br>
						좋은 서비스로 보답하겠습니다.<br>
						감사합니다.</div>
	<div class="button"><input type="button" value="로그인" id="btn" class="btn btn-primary py-3 px-5 mr-3" onclick="location.href='./Login.bo';"></div>
	<div class="button"><input type="button" value="홈으로" id="btn" class="btn btn-primary py-3 px-5 mr-3" onclick="location.href='./Main.bo';"></div>
</section>
<!-- ---------------------------------------------- 본문 끝 ---------------------------------------------- -->
<!-- ---------------------- 푸터 -------------------------------- -->
